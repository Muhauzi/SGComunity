                                ...
                                <div class="p-5">
                                    ...
                                    <?= csrf_field() ?>
                                        ...
                                        <div class="input-group border-0 mb-3">
                                            ...
                                            <span class="input-group-text border-0" id="icon"><i class="fa-solid fa-lock"></i></span>
                                            <input type="password" name="pass_confirm" class="form-control form-control-user border-0 <?php if (session('errors.pass_confirm')) : ?>is-invalid<?php endif ?>" placeholder="<?=lang('Auth.repeatPassword')?>" autocomplete="off">
                                        </div>
